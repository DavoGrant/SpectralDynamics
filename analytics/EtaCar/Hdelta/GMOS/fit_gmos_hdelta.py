...
# Fitting config.
concat_table = 'Hdelta_RegimeConcat1'
jd_tuples = [{'label': 'in-apastron-1', 'template': 'Harvard_GMOS_A1',
              'solver': 'CF', 'jd_rule': (2454665.500, 'before')},

             {'label': 'special-case-1', 'template': 'Harvard_GMOS_S1',
              'solver': 'CF', 'jd_rule': ((2454665.500, 2454779.837), 'between')},

             {'label': 'in-apastron-2', 'template': 'Harvard_GMOS_A1',
              'solver': 'CF', 'jd_rule': ((2454779.837, 2454835.815), 'between')},

             {'label': 'early-periastron', 'template': 'Harvard_GMOS_P1',
              'solver': 'CF', 'jd_rule': ((2454835.815, 2454835.833), 'between')},

             {'label': 'special-case-2', 'template': 'Harvard_GMOS_S2',
              'solver': 'CF', 'jd_rule': (2454835.8337037037, 'exact')},

             {'label': 'periastron-cont', 'template': 'Harvard_GMOS_P1',
              'solver': 'CF', 'jd_rule': ((2454835.835, 2454949.587), 'between')},

             {'label': 'out-apastron', 'template': 'Harvard_GMOS_P2',
              'solver': 'CF', 'jd_rule': (2454949.587, 'after')},
...
for regime in jd_tuples:
    ...
    fitter.add(etacar_templates.h_i_4101(version=regime['template'],
