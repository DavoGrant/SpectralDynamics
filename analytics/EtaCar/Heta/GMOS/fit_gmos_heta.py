...
# Fitting config.
concat_table = 'Heta_RegimeConcat1'
s_cases = [2454508.886804398, 2454779.839243056, 2454846.741513889,
           2454846.743130787, 2454860.8851539353, 2455036.527806713,
           2455204.845818287]
jd_tuples = [{'label': 'constant-1', 'template': 'Harvard_GMOS_C1',
              'solver': 'CF', 'jd_rule': (s_cases, 'except')},

             {'label': 'special-case-1', 'template': 'Harvard_GMOS_S1',
              'solver': 'CF', 'jd_rule': (s_cases, 'exact')},
...
for regime in jd_tuples:
    ...
    fitter.add(etacar_templates.h_i_3835(version=regime['template'],
