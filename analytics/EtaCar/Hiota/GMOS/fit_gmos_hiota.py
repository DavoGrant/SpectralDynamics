...
jd_tuples = [{'label': 'constant-1', 'template': 'Harvard_GMOS_C1',
              'solver': 'CF', 'jd_rule': (2454840.731, 'before')},

             {'label': 'constant-2', 'template': 'Harvard_GMOS_C2',
              'solver': 'CF', 'jd_rule': ((2454840.731, 2454949.587), 'between')},

             {'label': 'constant-3', 'template': 'Harvard_GMOS_C3',
...
for regime in jd_tuples:
    ...
    fitter.add(etacar_templates.h_i_3771(version=regime['template'],
